...
class TestRAGSystemQuery:
    ...
    def test_query_returns_response_and_sources_tuple(self, test_config, mock_vector_store_with_query_support):
        mock_client = MagicMock()
        mock_response = MagicMock()
        mock_response.content = [MagicMock(text="Computer use is a capability that allows AI models to interact with computers.")]
    ...
    def test_query_with_content_question_uses_search_tool(self, test_config, mock_vector_store_with_query_support):
        mock_client = MagicMock()
        ...
        final_response.content = [MagicMock(text="Computer use allows models to interact with computers through screenshots.")]
    ...
    def test_query_returns_sources_from_search_tool(self, test_config, mock_vector_store_with_query_support):
        mock_client = MagicMock()
    ...
    def test_query_with_session_id_includes_conversation_history(self, test_config, mock_vector_store_with_query_support):
        mock_client = MagicMock()
        mock_response = MagicMock()
    ...
    def test_query_updates_session_history_after_response(self, test_config, mock_vector_store_with_query_support):
        mock_client = MagicMock()
        mock_response = MagicMock()
...
class TestRAGSystemWithEmptyVectorStore:
    ...
    def test_query_with_empty_vector_store_returns_no_results_message(self, test_config):
        mock_client = MagicMock()
        ...
        final_response = MagicMock()
        final_response.content = [MagicMock(text="I couldn't find relevant information in the course materials.")]
        final_response.stop_reason = "end_turn"
